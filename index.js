...
project1.addEventListener("click", function() {
    changableImage.src = "https://cdn.pixabay.com/photo/2024/02/23/08/27/apple-8591539_1280.jpg";
});
project2.addEventListener("click", function() {
    changableImage.src = "https://res.cloudinary.com/detqp9dxl/image/upload/v1717316959/image_oe28ow.png";
});
project3.addEventListener("click", function() {
    changableImage.src = "https://cdn.pixabay.com/photo/2018/07/03/10/47/blueberries-3513547_1280.jpg";
});
...
function addHoveringEffect(cardId, imgId) {
    ...
    function hoveringCard() {
        ...
        card.classList.add('hover-bg-container', 'p-5', 'd-flex', 'flex-column', 'justify-content-center');
    ...
    function removeHoveringCard() {
        while (card.firstChild) {
            card.removeChild(card.firstChild);
        }

        card.classList.remove("d-none", 'hover-bg-container', 'p-5', 'd-flex', 'flex-column', 'justify-content-center');

        card.appendChild(img);
    };

    card.addEventListener("mouseover", hoveringCard);
    card.addEventListener("mouseout", removeHoveringCard);
}

// Adding hovering effect to all cards
addHoveringEffect("wwdCard", "wwdImg");
addHoveringEffect("wwdCard1", "wwdImg1");
addHoveringEffect("wwwCard2", "wwdImg2");
addHoveringEffect("wwwCard3", "wwwImg3");
addHoveringEffect("wwdCard4", "wwdImg4");
addHoveringEffect("wwwCard5", "wwwImg5");
addHoveringEffect("wwwCard6", "wwwImg6");
addHoveringEffect("wwwCard7", "wwwImg7");
addHoveringEffect("wwwCard8", "wwwImg8");
addHoveringEffect("wwwCard9", "wwwImg9");
addHoveringEffect("wwwCard10", "wwwImg10");
addHoveringEffect("wwwCard11", "wwwImg11");
